...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <h1>Productos Vendidos en el Trimestre 4 de 2022</h1>
        <table>
          <tr>
            <th>Referencia</th>
            <th>Nombre</th>
          ...
          <xsl:apply-templates select="//anio[@año='2022']/trimestre[@numero='4']/pedido/detalle_pedido/productos/producto"/>
        </table>
      </body>
    </html>
  </xsl:template>
